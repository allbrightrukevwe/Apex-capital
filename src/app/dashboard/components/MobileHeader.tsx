...
export default function MobileHeader() {
  ...
  return (
    <>
      <header className="lg:hidden sticky top-0 z-30 bg-slate-950 border-b border-teal-500/10 flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          <Link href="/dashboard/notifications" className="relative w-9 h-9 flex items-center justify-center rounded-full border border-slate-700 text-slate-400">
          ...
          <button
            ...
            className="w-9 h-9 flex items-center justify-center rounded-full border border-slate-700 text-slate-400"
          >
        ...
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 h-full bg-slate-900 border-r border-teal-500/10 flex flex-col z-10">
            <div className="px-5 py-4 border-b border-teal-500/10 flex items-center justify-between">
              <Link href="/" className="text-base font-bold tracking-wider" onClick={() => setOpen(false)}>
                <span className="text-white">APE</span>
                <span className="text-teal-400 text-2xl">X</span>
                <span className="text-white"> CAPITA</span>
              </Link>
            ...
            <div className="px-2.5 py-3 border-t border-teal-500/10 space-y-0.5">
              <button
                ...
                className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium text-slate-400 hover:text-red-400 hover:bg-red-500/10 transition w-full"
              >
