...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Email user deposit confirmation
    if (user?.email) {
      try {
        await transporter.sendMail({
          ...
          html: `
            <div style="font-family:sans-serif;max-width:480px;margin:0 auto;background:#0f172a;color:#fff;padding:32px;border-radius:16px">
              ...
              <p style="color:#94a3b8;font-size:13px">Send your crypto to the address shown on the deposit page. Your balance will be credited once confirmed.</p>
        ...
        console.error('Deposit confirmation email failed:', emailErr);
      }
    }
